...
class TestApi(unittest.TestCase):
    ...
    def test_api_gettodo_translate(self):
        ...
        self.assertEqual(
            jsonbody['text'], "Prueba de traduccion", "Error en la petición API a {url}"
        )
        #Test GET TODO - Traduccion a Ingles
        ...
        # Comprobamos que se ha realizado la traduccion
        self.assertEqual(
        ...
        print('End - integration test Get TODO Translate')
